...
from neptun.utils.services import TemplateService
...
template_app = typer.Typer(name="Template Manager",
                           help="Manage your neptun templates.")
...
@template_app.command(name="options", help="List all template options available.")
def list_template_options():
    options()


@template_app.command(name="create-collection", help="Create a new template collection.")
def create_template_collection():
    ...
    with Progress(
        ...
        result = template_service.create_template_collection(create_collection_request)
...
@template_app.command(name="list-collections", help="List all template collections.")
def list_template_collections(limit: int = None, select_last: bool = False):
    with Progress(
        ...
        collections_response = template_service.get_user_template_collections()
